...
!!! warning "Two different clients"
    JavaScript API cannot be used for scripts in SeaTable bases. For script programming with JavaScript, there is a [separate chapter](../scripting/index.md) in this documentation.
