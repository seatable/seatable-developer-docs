...
|---|---|---|
| **Auth** | Obtain base tokens and account tokens | [Auth API](https://github.com/seatable/seatable-api-php/blob/main/README_Auth.md) |
| **Base** | Rows, columns, views, links, metadata, SQL queries | [Base API](https://github.com/seatable/seatable-api-php/blob/main/README_Base.md) |
| **File** | Upload and download files and images | [File API](https://github.com/seatable/seatable-api-php/blob/main/README_File.md) |
