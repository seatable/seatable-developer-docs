...
<xsl:template match="/">
	...
	<head>
		<title>XML Sitemap — developer.seatable.com</title>
	...
	<div id="content">
		<h1>XML Sitemap</h1>
		<p class="expl">
			This is the XML Sitemap for <a href="https://developer.seatable.com">developer.seatable.com</a>, meant for consumption by search engines.<br/>
